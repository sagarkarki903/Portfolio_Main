...
export default function BurgerMenu({setBBurgerOpen}){
    ...
    const handleLinkClick = () => {
       ...
       <>
                ...
                <Link to={`/log`} onClick={handleLinkClick}><li><button className="bg-blue-500 hover:bg-blue-700 text-white text-center font-bold py-2 px-4 rounded-full">Sign In</button></li></Link>
